...
public abstract class ExamConsole {
	...
	//재사용을 위한 방법 제공? 연결고리? -> 추상메소드
	public ExamConsole() {
		exam = newExam(); // 널포인터 -> 실체를 만들어준다
	}
	...
	protected abstract void onPrint(Exam exam2);
